...
public class Mail {
	public static void Mails(String mail,String name)throws Exception{
		...
		ts.connect("smtp.qq.com","1372727770", "yecwgonnxjmifgfd");//后面的字符是授权码，用qq密码反正我是失败了（用自己的，别用我的，这个号是我瞎编的，为了。。。。）
		// 创建邮件
		...
		*/
		...
		// 邮件的文本内容
		message.setContent("验证码为:"+Mail+",请在5分钟内填写完成注册信息", "text/html;charset=UTF-8");
		// 返回创建好的邮件对象
		return message;
		}
		}
